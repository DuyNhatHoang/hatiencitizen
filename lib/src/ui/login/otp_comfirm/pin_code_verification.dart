...
class PinCodeVerificationScreen extends StatefulWidget {
  ...
  PinCodeVerificationScreen(this.phoneNumber, this.session);
            ...
            child: ListView(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                    AppLocalizations.of(context).validate + " " + AppLocalizations.of(context).phoneNumber,
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: SizeConfig.screenWidth * 0.06),
                ...
                Padding(
                  ...
                  child: RichText(
                    text: TextSpan(
                        text: AppLocalizations.of(context).codeSendToNumber,
                        children: [
                          TextSpan(
                        ...
                        style: TextStyle(color: Colors.black54, fontSize: SizeConfig.screenWidth * 0.035)),
                    textAlign: TextAlign.center,
                  ),
                ),
                SizedBox(
                          ...
                          if(state is OTPSuccess){
                            ...
                            showSnackBar(context, state.error.getErrorMessage());
                              ...
                              Navigator.of(context).pushReplacement(MaterialPageRoute(
                                  builder: (context) => MedicanPage(session: widget.session, phoneNumber: widget.phoneNumber,)));
                            }
                        },
