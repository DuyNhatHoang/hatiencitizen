                ...
                Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(color: Colors.black54, fontSize: 15),),
                    BlocProvider(create: (_) => ForgetPassBloc(authRepo: AuthRepo()),
                      child: BlocConsumer<ForgetPassBloc, ForgetPassState>(
                        listener: (context, state){
                          ...
                          if(state is ForgetPassVertifyOtpLoading){
                            common.push(
                              context,
                          ...
                          } else if(state is ForgetPassVertifyOtpError){
                            Navigator.of(context).pop();
                            showSnackBar(context, state.msg);
                          } else if(state is ForgetPassVertifyOtpLoaded){
                            showSnackBar(context, AppLocalizations.of(context).validateSuccess);
                            Navigator.of(context).pop();
                            print("ForgetPassVertifyOtpLoadedx ${state.id}");
                            Navigator.of(context).pushReplacement(
                                MaterialPageRoute(builder: (_) => ChangePassPage(phoneNumber: widget.phoneNumber, id: state.id,))
                            );
                          }
                        },
                          ...
                          return InkWell(
                            ...
                            onTap:(){
                              if( _activecodeCD > 0){
                                ...
                                BlocProvider.of<ForgetPassBloc>(context).add(SendOTPE(widget.phoneNumber));
                              }
                    ...
                    child: FlatButton(
                      onPressed: () {
                        ...
                        if (currentText.length != 6) {
                          ...
                          BlocProvider.of<ForgetPassBloc>(authContext).add(VertifyOtpE(widget.phoneNumber, textEditingController.text));
                        }
                      },
                      child: Center(
                          child: Text(
