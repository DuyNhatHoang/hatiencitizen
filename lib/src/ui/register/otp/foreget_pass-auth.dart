...
class ForgetPassAuthPage extends StatefulWidget {
  final String phoneNumber;
  final SessionManager session;
  const ForgetPassAuthPage({Key key, this.phoneNumber, this.session}) : super(key: key);

  @override
  _ForgetPassAuthPageState createState() => _ForgetPassAuthPageState();
}

class _ForgetPassAuthPageState extends State<ForgetPassAuthPage> {
  @override
